  ...
  return (
    <div className="flex flex-col gap-4 bg-black text-white">
      ...
      <Textarea id="query"
        ...
        className="min-h-[450px] focus-visible:ring-offset-1 pt-3 pl-4 pr-4 pb-3 rounded-none border-none font-light text-base leading-relaxed bg-neutral-950 placeholder:text-neutral-500 lowercase"
      />
    </div>
  );
};
